        ...
        <table class="table table-custom ">
          ...
          <tbody class="" id="tabla">
            ...
            <tr>
              ...
              <td><?php echo $val['unidadesPerdidas']?></td>
              <td><?php echo $val['descontinuado']?></td>
              <td>
                <a class="btn btn-danger" href="borrarProductos.php?id_producto=<?=$val['id_producto']?>&req=delete">Borrar</a>
              </td>
            </tr>
            <?php } ?>
        ...
        <div class="modal-content" >
          ...
          <div class="modal-body" style="background-color: rgb(231, 253, 246);">
            <form class="col d-flex flex-wrap" action="registrarProductos.php" method="post">
              ...
              <div class="mb-1 col-12">
                <label for="unidadesPerdidas" class="form-label">Unidades Perdidas</label>
                <input 
                  type="text"
                  id="unidadesPerdidas"
